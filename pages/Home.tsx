  ...
  return (
    <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 auto-rows-[350px]">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 p-12 w-full">
                ...
                <div className="text-white/80 text-[10px] font-bold uppercase tracking-widest group-hover:text-white transition-colors">Ver selección</div>
              </div>
            </div>
      ...
      <footer className="bg-stone-900 text-stone-400 py-12 px-8">
        <div className="max-w-[1600px] mx-auto grid md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-3 text-white mb-5">
              ...
              <span className="text-2xl font-display-serif font-bold tracking-tighter">accesorios18</span>
            </div>
            <p className="text-base font-serif italic mb-5 max-w-md leading-relaxed">
              Anudando emociones en historias vestibles, un hilo a la vez. Hecho con amor en Venezuela.
            </p>
          </div>
          <div className="col-span-1 space-y-3">
            <h4 className="text-white uppercase tracking-[0.3em] text-[11px] font-black mb-5">Explorar</h4>
            <ul className="space-y-3 text-[11px] uppercase tracking-widest font-bold">
          ...
          <div className="col-span-1">
            <h4 className="text-white uppercase tracking-[0.3em] text-[11px] font-black mb-5">Boletín</h4>
            <div className="relative border-b border-stone-700 py-3">
        ...
        <div className="max-w-[1600px] mx-auto mt-12 pt-6 border-t border-white/5 text-[10px] uppercase tracking-widest font-bold flex flex-col md:flex-row justify-between gap-4">
